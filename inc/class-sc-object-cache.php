 ...
 */
class bestwebsite_Object_Cache {
	/**
	...
	public function get_file_code() {
		...
		return '<?php ' .
		"\r\n" . "defined( 'ABSPATH' ) || exit;" .
		"\r\n" . "define( 'bestwebsite_OBJECT_CACHE', true );" .
		...
		"\r\n" . "if ( empty( \$GLOBALS['bestwebsite_config'] ) || empty( \$GLOBALS['bestwebsite_config']['enable_in_memory_object_caching'] ) ) { return; }" .
		"\r\n" . "if ( @file_exists( \$plugin_path . '/bestwebsite-simple-cache/inc/dropins/" . $cache_file . "' ) ) { require_once( \$plugin_path . '/bestwebsite-simple-cache/inc/dropins/" . $cache_file . "' ); }" . "\r\n";
		// phpcs:enable
	}
