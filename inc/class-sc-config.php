...
class bestwebsite_Config {
	...
	public function write( $config, $force_network = false ) {
		...
		$config_dir = bestwebsite_get_config_dir();
	...
	public function get() {
		if ( bestwebsite_IS_NETWORK ) {
			$config = get_site_option( 'bestwebsite_simple_cache', $this->get_defaults() );
		} else {
			$config = get_option( 'bestwebsite_simple_cache', $this->get_defaults() );
		}
	...
	public function clean_up() {
		...
		if ( bestwebsite_IS_NETWORK ) {
			delete_site_option( 'bestwebsite_simple_cache' );
		} else {
			delete_option( 'bestwebsite_simple_cache' );
		}
