...
if ( empty( $batcache ) && ! empty( $GLOBALS['bestwebsite_config'] ) && isset( $GLOBALS['bestwebsite_config']['page_cache_length'] ) ) {
	$max_age = $GLOBALS['bestwebsite_config']['page_cache_length'] * 60;
...
if ( ! empty( $GLOBALS['bestwebsite_config']['cache_exception_urls'] ) ) {
