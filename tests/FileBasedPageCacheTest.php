...
class FileBasedPageCacheTest extends \PHPUnit\Framework\TestCase {
	...
	public function test_url_exception_match() {
		...
		$this->assertTrue( bestwebsite_url_exception_match( $exception ) );
		$_SERVER = array();
		...
		$this->assertFalse( bestwebsite_url_exception_match( $exception ) );
		$_SERVER = array();
	...
	public function test_url_exception_match_regex() {
		...
		$this->assertTrue( bestwebsite_url_exception_match( $exception, true ) );
		$_SERVER = array();
		...
		$this->assertFalse( bestwebsite_url_exception_match( $exception, true ) );
		$_SERVER = array();
